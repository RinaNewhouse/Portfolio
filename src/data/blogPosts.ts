...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
      ...
      Your portfolio isn’t stor<em>age</em>; it’s a stor<em>y</em>. Make one project a month. Post the process, not just the polish. Proof builds momentum. Momentum attracts opportunity. 
